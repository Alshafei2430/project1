...
<a class="reference internal" href="#sqlalchemy.dialects.postgresql.insert" title="sqlalchemy.dialects.postgresql.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">postgresql.insert()</span></code></a> function, which provides
the generative methods <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update" title="sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">on_conflict_do_update()</span></code></a>
and <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_nothing" title="sqlalchemy.dialects.postgresql.Insert.on_conflict_do_nothing"><code class="xref py py-meth docutils literal notranslate"><span class="pre">on_conflict_do_nothing()</span></code></a>:</p>
...
<p>The <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update" title="sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.on_conflict_do_update()</span></code></a> method does <strong>not</strong> take into
...
<a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.excluded" title="sqlalchemy.dialects.postgresql.Insert.excluded"><code class="xref py py-attr docutils literal notranslate"><span class="pre">excluded</span></code></a> is available as an attribute on
the <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert" title="sqlalchemy.dialects.postgresql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.Insert</span></code></a> object; this object is a
...
<p>The <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update" title="sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.on_conflict_do_update()</span></code></a> method also accepts
...
<a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_nothing" title="sqlalchemy.dialects.postgresql.Insert.on_conflict_do_nothing"><code class="xref py py-meth docutils literal notranslate"><span class="pre">on_conflict_do_nothing()</span></code></a> method:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy.dialects.postgresql</span> <span class="k">import</span> <span class="n">insert</span>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.base.</code><code class="sig-name descname">PGInspector</code><span class="sig-paren">(</span><em class="sig-param">conn</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.base.PGInspector" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">get_enums</code><span class="sig-paren">(</span><em class="sig-param">schema=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.base.PGInspector.get_enums" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">get_foreign_table_names</code><span class="sig-paren">(</span><em class="sig-param">schema=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.base.PGInspector.get_foreign_table_names" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">get_table_oid</code><span class="sig-paren">(</span><em class="sig-param">table_name</em>, <em class="sig-param">schema=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.base.PGInspector.get_table_oid" title="Permalink to this definition">¶</a></dt>
<dd><p>Return the OID for the given table name.</p>
</dd></dl>

<dl class="method">
<dt id="sqlalchemy.dialects.postgresql.base.PGInspector.get_view_names">
<code class="sig-name descname">get_view_names</code><span class="sig-paren">(</span><em class="sig-param">schema=None</em>, <em class="sig-param">include=('plain'</em>, <em class="sig-param">'materialized')</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.base.PGInspector.get_view_names" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a> datatype.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">aggregate_order_by</code><span class="sig-paren">(</span><em class="sig-param">target</em>, <em class="sig-param">*order_by</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.aggregate_order_by" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">array</code><span class="sig-paren">(</span><em class="sig-param">clauses</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.array" title="Permalink to this definition">¶</a></dt>
...
The dimensionality of the final <a class="reference internal" href="#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">ARRAY</span></code></a> type is calculated by
recursively adding the dimensions of the inner <a class="reference internal" href="#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">ARRAY</span></code></a> type:</p>
...
<em class="property">class </em><code class="sig-name descname">Comparator</code><span class="sig-paren">(</span><em class="sig-param">expr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ARRAY.Comparator" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contained_by</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ARRAY.Comparator.contained_by" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contains</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ARRAY.Comparator.contains" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">overlap</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ARRAY.Comparator.overlap" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">array_agg</code><span class="sig-paren">(</span><em class="sig-param">*arg</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.array_agg" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">BIT</code><span class="sig-paren">(</span><em class="sig-param">length=None</em>, <em class="sig-param">varying=False</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.BIT" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">BYTEA</code><span class="sig-paren">(</span><em class="sig-param">length=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.BYTEA" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">length=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.BYTEA.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">DOUBLE_PRECISION</code><span class="sig-paren">(</span><em class="sig-param">precision=None</em>, <em class="sig-param">asdecimal=False</em>, <em class="sig-param">decimal_return_scale=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.DOUBLE_PRECISION" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">precision=None</em>, <em class="sig-param">asdecimal=False</em>, <em class="sig-param">decimal_return_scale=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.DOUBLE_PRECISION.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">ENUM</code><span class="sig-paren">(</span><em class="sig-param">*enums</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ENUM" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">*enums</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ENUM.__init__" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">create</code><span class="sig-paren">(</span><em class="sig-param">bind=None</em>, <em class="sig-param">checkfirst=True</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ENUM.create" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">drop</code><span class="sig-paren">(</span><em class="sig-param">bind=None</em>, <em class="sig-param">checkfirst=True</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ENUM.drop" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">HSTORE</code><span class="sig-paren">(</span><em class="sig-param">text_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-name descname">Comparator</code><span class="sig-paren">(</span><em class="sig-param">expr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">array</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.array" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contained_by</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.contained_by" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contains</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.contains" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">defined</code><span class="sig-paren">(</span><em class="sig-param">key</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.defined" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">delete</code><span class="sig-paren">(</span><em class="sig-param">key</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.delete" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">has_all</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.has_all" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">has_any</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.has_any" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">has_key</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.has_key" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">keys</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.keys" title="Permalink to this definition">¶</a></dt>
<dd><p>Text array expression.  Returns array of keys.</p>
</dd></dl>

<dl class="method">
<dt id="sqlalchemy.dialects.postgresql.HSTORE.Comparator.matrix">
<code class="sig-name descname">matrix</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.matrix" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">slice</code><span class="sig-paren">(</span><em class="sig-param">array</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.slice" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">vals</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.Comparator.vals" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">text_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.__init__" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">bind_processor</code><span class="sig-paren">(</span><em class="sig-param">dialect</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.bind_processor" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">comparator_factory</code><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.comparator_factory" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">result_processor</code><span class="sig-paren">(</span><em class="sig-param">dialect</em>, <em class="sig-param">coltype</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.HSTORE.result_processor" title="Permalink to this definition">¶</a></dt>
...
<dl class="class">
<dt id="sqlalchemy.dialects.postgresql.hstore">
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">hstore</code><span class="sig-paren">(</span><em class="sig-param">*args</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.hstore" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">type</code><a class="headerlink" href="#sqlalchemy.dialects.postgresql.hstore.type" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">INTERVAL</code><span class="sig-paren">(</span><em class="sig-param">precision=None</em>, <em class="sig-param">fields=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.INTERVAL" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">precision=None</em>, <em class="sig-param">fields=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.INTERVAL.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">JSON</code><span class="sig-paren">(</span><em class="sig-param">none_as_null=False</em>, <em class="sig-param">astext_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSON" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON.Comparator.as_string" title="sqlalchemy.types.JSON.Comparator.as_string"><code class="xref py py-attr docutils literal notranslate"><span class="pre">JSON.Comparator.as_string</span></code></a> accessor.</p>
</li>
...
<p>Note that equivalent functionality is available via the
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON.Comparator.as_integer" title="sqlalchemy.types.JSON.Comparator.as_integer"><code class="xref py py-attr docutils literal notranslate"><span class="pre">JSON.Comparator.as_integer</span></code></a> and similar accessors.</p>
</li>
...
<em class="property">class </em><code class="sig-name descname">Comparator</code><span class="sig-paren">(</span><em class="sig-param">expr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSON.Comparator" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Comparator</span></code></p>
...
<code class="sig-name descname">astext</code><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSON.Comparator.astext" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">none_as_null=False</em>, <em class="sig-param">astext_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSON.__init__" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">comparator_factory</code><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSON.comparator_factory" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">JSONB</code><span class="sig-paren">(</span><em class="sig-param">none_as_null=False</em>, <em class="sig-param">astext_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-name descname">Comparator</code><span class="sig-paren">(</span><em class="sig-param">expr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.Comparator" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contained_by</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.Comparator.contained_by" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression.  Test if keys are a proper subset of the
keys of the argument jsonb expression.</p>
</dd></dl>
...
<code class="sig-name descname">contains</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.Comparator.contains" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression.  Test if keys (or array) are a superset
of/contained the keys of the argument jsonb expression.</p>
</dd></dl>
...
<code class="sig-name descname">has_all</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.Comparator.has_all" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression.  Test for presence of all keys in jsonb</p>
</dd></dl>

<dl class="method">
<dt id="sqlalchemy.dialects.postgresql.JSONB.Comparator.has_any">
<code class="sig-name descname">has_any</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.Comparator.has_any" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression.  Test for presence of any key in jsonb</p>
</dd></dl>

<dl class="method">
<dt id="sqlalchemy.dialects.postgresql.JSONB.Comparator.has_key">
<code class="sig-name descname">has_key</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.Comparator.has_key" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression.  Test for presence of a key.  Note that the
key may be a SQLA expression.</p>
</dd></dl>
...
<code class="sig-name descname">comparator_factory</code><a class="headerlink" href="#sqlalchemy.dialects.postgresql.JSONB.comparator_factory" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">REAL</code><span class="sig-paren">(</span><em class="sig-param">precision=None</em>, <em class="sig-param">asdecimal=False</em>, <em class="sig-param">decimal_return_scale=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.REAL" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Float" title="sqlalchemy.types.Float"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Float</span></code></a></p>
<p>The SQL REAL type.</p>
<dl class="method">
<dt id="sqlalchemy.dialects.postgresql.REAL.__init__">
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">precision=None</em>, <em class="sig-param">asdecimal=False</em>, <em class="sig-param">decimal_return_scale=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.REAL.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Float.__init__" title="sqlalchemy.types.Float.__init__"><code class="xref py py-meth docutils literal notranslate"><span class="pre">__init__()</span></code></a> <em>method of</em> <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Float" title="sqlalchemy.types.Float"><code class="xref py py-class docutils literal notranslate"><span class="pre">Float</span></code></a></p>
</div>
<p>Construct a Float.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">UUID</code><span class="sig-paren">(</span><em class="sig-param">as_uuid=False</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.UUID" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <a class="reference internal" href="../core/type_api.html#sqlalchemy.types.TypeEngine" title="sqlalchemy.types.TypeEngine"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.TypeEngine</span></code></a></p>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">as_uuid=False</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.UUID.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-name descname">comparator_factory</code><span class="sig-paren">(</span><em class="sig-param">expr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Comparator</span></code></p>
...
<code class="sig-name descname">__ne__</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.__ne__" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">adjacent_to</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.adjacent_to" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contained_by</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.contained_by" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">contains</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.contains" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">not_extend_left_of</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.not_extend_left_of" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression. Returns true if the range in the column
...
<code class="sig-name descname">not_extend_right_of</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.not_extend_right_of" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression. Returns true if the range in the column
...
<code class="sig-name descname">overlaps</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.overlaps" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">strictly_left_of</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.strictly_left_of" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">strictly_right_of</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators.comparator_factory.strictly_right_of" title="Permalink to this definition">¶</a></dt>
<dd><p>Boolean expression. Returns true if the column is strictly
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">ExcludeConstraint</code><span class="sig-paren">(</span><em class="sig-param">*elements</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ExcludeConstraint" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">*elements</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.ExcludeConstraint.__init__" title="Permalink to this definition">¶</a></dt>
...
typically a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a> object, and “operator” is a string
containing the operator to use.   In order to specify a column name
when a  <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a> object is not available, while ensuring
that any necessary quoting rules take effect, an ad-hoc
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a> or <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.column" title="sqlalchemy.sql.expression.column"><code class="xref py py-func docutils literal notranslate"><span class="pre">sql.expression.column()</span></code></a> object should be
used.</p></li>
...
<code class="sig-prename descclassname">sqlalchemy.dialects.postgresql.</code><code class="sig-name descname">insert</code><span class="sig-paren">(</span><em class="sig-param">table</em>, <em class="sig-param">values=None</em>, <em class="sig-param">inline=False</em>, <em class="sig-param">bind=None</em>, <em class="sig-param">prefixes=None</em>, <em class="sig-param">returning=None</em>, <em class="sig-param">return_defaults=False</em>, <em class="sig-param">**dialect_kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.insert" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p>Inherited from <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.insert" title="sqlalchemy.sql.expression.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">sqlalchemy.sql.expression.insert()</span></code></a>; this constructor creates a <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert" title="sqlalchemy.dialects.postgresql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">dialects.postgresql.Insert</span></code></a> object</p>
</div>
<p>Construct an <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert" title="sqlalchemy.dialects.postgresql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">Insert</span></code></a> object.</p>
<p>Similar functionality is available via the
<a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.TableClause.insert" title="sqlalchemy.sql.expression.TableClause.insert"><code class="xref py py-meth docutils literal notranslate"><span class="pre">insert()</span></code></a> method on
...
<a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert.values" title="sqlalchemy.sql.expression.Insert.values"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.values()</span></code></a> for a description of allowed formats here.
Can be omitted entirely; a <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert" title="sqlalchemy.dialects.postgresql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">Insert</span></code></a> construct will also
...
<p>The <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert" title="sqlalchemy.dialects.postgresql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.Insert</span></code></a> object is created using the
...
<code class="sig-name descname">excluded</code><a class="headerlink" href="#sqlalchemy.dialects.postgresql.Insert.excluded" title="Permalink to this definition">¶</a></dt>
...
to use <a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert.excluded" title="sqlalchemy.dialects.postgresql.Insert.excluded"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Insert.excluded</span></code></a></p>
</div>
</dd></dl>

<dl class="method">
<dt id="sqlalchemy.dialects.postgresql.Insert.on_conflict_do_nothing">
<code class="sig-name descname">on_conflict_do_nothing</code><span class="sig-paren">(</span><em class="sig-param">constraint=None</em>, <em class="sig-param">index_elements=None</em>, <em class="sig-param">index_where=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_nothing" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">on_conflict_do_update</code><span class="sig-paren">(</span><em class="sig-param">constraint=None</em>, <em class="sig-param">index_elements=None</em>, <em class="sig-param">index_where=None</em>, <em class="sig-param">set_=None</em>, <em class="sig-param">where=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.postgresql.Insert.on_conflict_do_update" title="Permalink to this definition">¶</a></dt>
...
<span id="psycopg2-executemany-mode"></span><h3>Psycopg2 Fast Execution Helpers<a class="headerlink" href="#psycopg2-fast-execution-helpers" title="Permalink to this headline">¶</a></h3>
...
calls invoked by an <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a> when used with <a class="reference internal" href="../core/tutorial.html#execute-multiple"><span class="std std-ref">multiple parameter
...
<li><p><code class="docutils literal notranslate"><span class="pre">'values'</span></code>- For Core <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.insert" title="sqlalchemy.sql.expression.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">insert()</span></code></a> constructs only (including those
...
<a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.insert" title="sqlalchemy.sql.expression.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">insert()</span></code></a> construct where the format is predictable.  For all other
...
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> object to execute statements in such a way as to make
