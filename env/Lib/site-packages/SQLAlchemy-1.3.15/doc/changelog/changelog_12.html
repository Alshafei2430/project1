...
<li><span class="link-container"><a class="reference external" href="#change-1.2.20">1.2.20</a></span></li>
...
<div class="section" id="change-1.2.20">
<h2 class="release-version">1.2.20<a class="headerlink" href="#change-1.2.20" title="Permalink to this headline">¶</a></h2>
no release date</div>
...
<li><p id="change-1.2.0b3-26"><span class="target" id="change-f578628285ac401ee2041f8631749e12"><strong>[postgresql] [bug]</strong> </span><p>Fixed bug in PostgreSQL <code class="xref py py-meth docutils literal notranslate"><span class="pre">postgresql.dml.Insert.on_conflict_do_update()</span></code>
...
MySQL-specific <code class="xref py py-class docutils literal notranslate"><span class="pre">mysql.dml.Insert</span></code> object.
