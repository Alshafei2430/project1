...
<li><span class="link-container"><a class="reference external" href="#change-1.1.19">1.1.19</a></span></li>
...
<div class="section" id="change-1.1.19">
<h2 class="release-version">1.1.19<a class="headerlink" href="#change-1.1.19" title="Permalink to this headline">¶</a></h2>
no release date</div>
...
<li><p id="change-1.1.15-8"><span class="target" id="change-7b1ff1c5593213a5714b4635ab92498d"><strong>[postgresql] [bug]</strong> </span><p>Fixed bug in PostgreSQL <code class="xref py py-meth docutils literal notranslate"><span class="pre">postgresql.dml.Insert.on_conflict_do_update()</span></code>
...
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.text" title="sqlalchemy.sql.expression.text"><code class="xref py py-func docutils literal notranslate"><span class="pre">sql.expression.text()</span></code></a> construct.  Clarified the documentation
...
<ul class="simple">
<li><p id="change-1.1.6-10"><span class="target" id="change-3259723b8e663f9fb6b5398da7b34e65"><strong>[feature] [ext]</strong> </span><p>Added <a class="reference internal" href="../orm/extensions/baked.html#sqlalchemy.ext.baked.Result.scalar" title="sqlalchemy.ext.baked.Result.scalar"><code class="xref py py-meth docutils literal notranslate"><span class="pre">baked.Result.scalar()</span></code></a> and <a class="reference internal" href="../orm/extensions/baked.html#sqlalchemy.ext.baked.Result.count" title="sqlalchemy.ext.baked.Result.count"><code class="xref py py-meth docutils literal notranslate"><span class="pre">baked.Result.count()</span></code></a>
...
<li><p id="change-1.1.5-7"><span class="target" id="change-77d647ab4eb38f6ded1617afdd668bbc"><strong>[sql] [bug]</strong> </span><p>Fixed 1.1 regression where “import <a href="#id2"><span class="problematic" id="id3">*</span></a>” would not work for
...
<li><p id="change-1.1.5-12"><span class="target" id="change-6ad76c3b093a976445321ade675965c3"><strong>[postgresql] [bug]</strong> </span><p>The <code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.TIME</span></code> and <code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.TIMESTAMP</span></code>
...
“raise_on_sql” variant, available both via <a class="reference internal" href="../orm/relationship_api.html#sqlalchemy.orm.relationship.params.lazy" title="sqlalchemy.orm.relationship"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">orm.relationship.lazy</span></code></a>
as well as <a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.raiseload" title="sqlalchemy.orm.raiseload"><code class="xref py py-func docutils literal notranslate"><span class="pre">orm.raiseload()</span></code></a>.   This variant only raises if the
...
handling by the <a class="reference internal" href="../core/events.html#sqlalchemy.events.ConnectionEvents.handle_error" title="sqlalchemy.events.ConnectionEvents.handle_error"><code class="xref py py-meth docutils literal notranslate"><span class="pre">handle_error()</span></code></a>
...
rare occurrence in 1.0, however in 1.1 <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a>
subclasses <code class="xref py py-class docutils literal notranslate"><span class="pre">sqltypes.ARRAY</span></code> and has this behavior.
As a result, setting up a compilation handler for another dialect
such as SQLite would render the main <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a>
...
<li><p id="change-1.1.0b1-4"><span class="target" id="change-ebaee83acc1f8f12b712ab57c6ce231d"><strong>[orm] [feature]</strong> </span><p>Added new parameter <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.params.passive_deletes" title="sqlalchemy.orm.mapper"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">orm.mapper.passive_deletes</span></code></a> to
...
<a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.noload" title="sqlalchemy.orm.noload"><code class="xref py py-func docutils literal notranslate"><span class="pre">orm.noload()</span></code></a> but instead of returning <code class="docutils literal notranslate"><span class="pre">None</span></code> it raises an
...
in conjunction with the PostgreSQL <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSON</span></code></a> type.  When
...
<li><p id="change-1.1.0b1-24"><span class="target" id="change-09669497f855398505a14d647f0b239c"><strong>[orm] [change]</strong> </span><p>The <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper.params.order_by" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Mapper.order_by</span></code></a> parameter is deprecated.
...
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.over.params.range_" title="sqlalchemy.sql.expression.over"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">expression.over.range_</span></code></a> and
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.over.params.rows" title="sqlalchemy.sql.expression.over"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">expression.over.rows</span></code></a> parameters.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
enumeration libraries, to the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal notranslate"><span class="pre">types.Enum</span></code></a> datatype.
The <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal notranslate"><span class="pre">types.Enum</span></code></a> datatype now also performs in-Python validation
...
<li><p id="change-1.1.0b1-41"><span class="target" id="change-17c3b4f058ed555d27ca96a245bdde91"><strong>[sql] [feature]</strong> </span><p>Added a new type to core <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">types.JSON</span></code></a>.  This is the
base of the PostgreSQL <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSON</span></code></a> type as well as that
of the new <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">mysql.JSON</span></code></a> type, so that a PG/MySQL-agnostic
...
which automatically returns an <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a> of the correct type
and supports index / slice operations, as well as
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.array_agg" title="sqlalchemy.dialects.postgresql.array_agg"><code class="xref py py-func docutils literal notranslate"><span class="pre">postgresql.array_agg()</span></code></a>, which returns a <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a>
...
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.aggregate_order_by" title="sqlalchemy.dialects.postgresql.aggregate_order_by"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.aggregate_order_by</span></code></a> in support of PG’s
...
<li><p id="change-1.1.0b1-44"><span class="target" id="change-073de265914ed4fee6ddbc41fb452906"><strong>[sql] [feature]</strong> </span><p>Added a new type to core <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY" title="sqlalchemy.types.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">types.ARRAY</span></code></a>.  This is the
base of the PostgreSQL <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a> type, and is now part of Core
...
Additionally, new operators <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.any_" title="sqlalchemy.sql.expression.any_"><code class="xref py py-func docutils literal notranslate"><span class="pre">expression.any_()</span></code></a> and
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.all_" title="sqlalchemy.sql.expression.all_"><code class="xref py py-func docutils literal notranslate"><span class="pre">expression.all_()</span></code></a> have been added.  These support not just
...
PostgreSQL-specific <code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.dml.Insert</span></code> object.
...
<li><p id="change-1.1.0b1-59"><span class="target" id="change-19aa6de2dd87b7d89df8d37af407d32c"><strong>[postgresql] [feature]</strong> </span><p>Added a new constant <code class="xref py py-attr docutils literal notranslate"><span class="pre">postgresql.JSON.NULL</span></code>, indicating
...
<li><p id="change-1.1.0b1-63"><span class="target" id="change-8da75e31c8cd6d00e80ba3917b6d4e5b"><strong>[postgresql] [bug]</strong> </span><p>The PostgreSQL <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a> type now supports multidimensional
...
that the <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY.params.dimensions" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">postgresql.ARRAY.dimensions</span></code></a> parameter is set to the
...
<li><p id="change-1.1.0b1-64"><span class="target" id="change-955064818187d78a11ba0c613973c45a"><strong>[postgresql] [bug]</strong> </span><p>The return type for the <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSON</span></code></a> and <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSONB" title="sqlalchemy.dialects.postgresql.JSONB"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSONB</span></code></a>
when using indexed access has been fixed to work like PostgreSQL itself,
and returns an expression that itself is of type <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSON</span></code></a>
or <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSONB" title="sqlalchemy.dialects.postgresql.JSONB"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSONB</span></code></a>.  Previously, the accessor would return
...
<li><p id="change-1.1.0b1-65"><span class="target" id="change-e131ab33b04196b6d2081a5e820d4974"><strong>[postgresql] [bug]</strong> </span><p>The <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSON</span></code></a>, <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSONB" title="sqlalchemy.dialects.postgresql.JSONB"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.JSONB</span></code></a> and
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.HSTORE" title="sqlalchemy.dialects.postgresql.HSTORE"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.HSTORE</span></code></a> datatypes now allow full control over the
...
via the <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON.params.astext_type" title="sqlalchemy.dialects.postgresql.JSON"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">postgresql.JSON.astext_type</span></code></a> and
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.HSTORE.params.text_type" title="sqlalchemy.dialects.postgresql.HSTORE"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">postgresql.HSTORE.text_type</span></code></a> parameters.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="migration_11.html#change-3503"><span class="std std-ref">Correct SQL Types are Established from Indexed Access of ARRAY, JSON, HSTORE</span></a></p>
</div>
...
<li><p id="change-1.1.0b1-66"><span class="target" id="change-6dfedfbab62807e6296ba6410d21fa16"><strong>[postgresql] [bug]</strong> </span><p>The <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON.Comparator.astext" title="sqlalchemy.dialects.postgresql.JSON.Comparator.astext"><code class="xref py py-attr docutils literal notranslate"><span class="pre">postgresql.JSON.Comparator.astext</span></code></a> modifier no longer
...
to call <a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.JSON.Comparator.astext" title="sqlalchemy.dialects.postgresql.JSON.Comparator.astext"><code class="xref py py-attr docutils literal notranslate"><span class="pre">postgresql.JSON.Comparator.astext</span></code></a> explicitly.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
<li><p id="change-1.1.0b1-69"><span class="target" id="change-1f91faadfeca6a6deca2362e7f770a4c"><strong>[mysql] [feature]</strong> </span><p>Added <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">mysql.JSON</span></code></a> for MySQL 5.7.  The JSON type provides
