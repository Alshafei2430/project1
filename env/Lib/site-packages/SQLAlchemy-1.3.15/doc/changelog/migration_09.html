...
<p>The potentially backwards incompatible change arises if the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.collate" title="sqlalchemy.schema.Column.collate"><code class="xref py py-meth docutils literal notranslate"><span class="pre">collate()</span></code></a>
