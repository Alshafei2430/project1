...
<li><p id="change-0.9.8-23"><span class="target" id="change-8d9ef3d42e12a3991355d6db0d7e0590"><strong>[bug] [ext]</strong> </span><p>Fixed bug where <a class="reference internal" href="../orm/extensions/mutable.html#sqlalchemy.ext.mutable.MutableDict" title="sqlalchemy.ext.mutable.MutableDict"><code class="xref py py-class docutils literal notranslate"><span class="pre">ext.mutable.MutableDict</span></code></a>
...
<li><p id="change-0.9.8-24"><span class="target" id="change-2995e85c7b79e5acb0500b5f7bef1116"><strong>[bug] [ext]</strong> </span><p>Fixed bug where a custom subclass of <a class="reference internal" href="../orm/extensions/mutable.html#sqlalchemy.ext.mutable.MutableDict" title="sqlalchemy.ext.mutable.MutableDict"><code class="xref py py-class docutils literal notranslate"><span class="pre">ext.mutable.MutableDict</span></code></a>
...
<li><p id="change-0.9.5-22"><span class="target" id="change-a3459e488927e82388dc6b3a4452b01b"><strong>[postgresql] [feature]</strong> </span><p>Added a new flag <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.ARRAY.params.zero_indexes" title="sqlalchemy.types.ARRAY"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">ARRAY.zero_indexes</span></code></a> to the PostgreSQL
...
<ul class="simple">
<li><p id="change-0.9.4-3"><span class="target" id="change-9e23c7c28f359372f92c6661ec54a74f"><strong>[orm] [feature]</strong> </span><p>Added new parameter <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.params.confirm_deleted_rows" title="sqlalchemy.orm.mapper"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">orm.mapper.confirm_deleted_rows</span></code></a>.  Defaults
...
for the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-class docutils literal notranslate"><span class="pre">Mapper</span></code></a> target at the general level.</p>
<a class="changelog-reference headerlink reference internal" href="#change-4dbefa991bc15832dbd5722613a9ec8b">¶</a><p></p>
</p>
</li>
<li><p id="change-0.9.4-5"><span class="target" id="change-aef7530390a87c53f08a067e5881ebc8"><strong>[orm] [feature]</strong> </span><p>Added a new keyword argument <code class="docutils literal notranslate"><span class="pre">once=True</span></code> to <a class="reference internal" href="../core/event.html#sqlalchemy.event.listen" title="sqlalchemy.event.listen"><code class="xref py py-func docutils literal notranslate"><span class="pre">event.listen()</span></code></a>
and <a class="reference internal" href="../core/event.html#sqlalchemy.event.listens_for" title="sqlalchemy.event.listens_for"><code class="xref py py-func docutils literal notranslate"><span class="pre">event.listens_for()</span></code></a>.  This is a convenience feature which
...
flag for <a class="reference internal" href="../core/event.html#sqlalchemy.event.listen" title="sqlalchemy.event.listen"><code class="xref py py-func docutils literal notranslate"><span class="pre">event.listen()</span></code></a> to work with mapper / instance events.</p>
...
level (e.g. on the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-class docutils literal notranslate"><span class="pre">Mapper</span></code></a> or <a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.instrumentation.ClassManager" title="sqlalchemy.orm.instrumentation.ClassManager"><code class="xref py py-class docutils literal notranslate"><span class="pre">ClassManager</span></code></a>
...
<a class="reference internal" href="../orm/loading_relationships.html#sqlalchemy.orm.lazyload" title="sqlalchemy.orm.lazyload"><code class="xref py py-func docutils literal notranslate"><span class="pre">orm.lazyload()</span></code></a> with the “wildcard” expression, e.g. <code class="docutils literal notranslate"><span class="pre">&quot;*&quot;</span></code>,
...
<li><p id="change-0.9.4-22"><span class="target" id="change-eb76a93c5c1ba58cc198d3783e1d4d74"><strong>[sql] [feature]</strong> </span><p>Added a new feature <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.conv" title="sqlalchemy.schema.conv"><code class="xref py py-func docutils literal notranslate"><span class="pre">schema.conv()</span></code></a>, the purpose of which is to
...
<li><p id="change-0.9.4-35"><span class="target" id="change-5861886a0faf27d02c29bdac44e39a74"><strong>[oracle] [bug]</strong> </span><p>Added new datatype <a class="reference internal" href="../dialects/oracle.html#sqlalchemy.dialects.oracle.DATE" title="sqlalchemy.dialects.oracle.DATE"><code class="xref py py-class docutils literal notranslate"><span class="pre">oracle.DATE</span></code></a>, which is a subclass of
...
<li><p id="change-0.9.3-9"><span class="target" id="change-d04236a265c2b96a0d1c28f0cb10ee98"><strong>[sql] [bug]</strong> </span><p>Fixed bug where <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.in_" title="sqlalchemy.schema.Column.in_"><code class="xref py py-meth docutils literal notranslate"><span class="pre">in_()</span></code></a> would go into an endless loop if
...
<a class="changelog-reference headerlink reference internal" href="#change-d04236a265c2b96a0d1c28f0cb10ee98">¶</a><p>This change is also <strong>backported</strong> to: 0.8.5</p>
...
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.ARRAY" title="sqlalchemy.dialects.postgresql.ARRAY"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.ARRAY</span></code></a> type.  Pull request courtesy Alexey Terentev.</p>
...
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table.params.schema" title="sqlalchemy.schema.Table"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">schema</span></code></a> argument.   Pull request
...
as the <code class="xref py py-meth docutils literal notranslate"><span class="pre">Text.columns()</span></code> method is called to accommodate the
...
of <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.ENUM" title="sqlalchemy.dialects.mysql.ENUM"><code class="xref py py-class docutils literal notranslate"><span class="pre">mysql.ENUM</span></code></a> being downcast into a <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal notranslate"><span class="pre">types.Enum</span></code></a>,
...
<ul class="simple">
<li><p id="change-0.9.0-0"><span class="target" id="change-6f14ee03b908f78d8d174e7ef588746d"><strong>[orm] [feature]</strong> </span><p>The <a class="reference internal" href="../core/exceptions.html#sqlalchemy.exc.StatementError" title="sqlalchemy.exc.StatementError"><code class="xref py py-class docutils literal notranslate"><span class="pre">exc.StatementError</span></code></a> or DBAPI-related subclass
...
<a class="reference internal" href="../dialects/postgresql.html#sqlalchemy.dialects.postgresql.TSVECTOR" title="sqlalchemy.dialects.postgresql.TSVECTOR"><code class="xref py py-class docutils literal notranslate"><span class="pre">postgresql.TSVECTOR</span></code></a> type.  Pull request courtesy
Noufal Ibrahim.</p>
...
<li><p id="change-0.9.0b1-6"><span class="target" id="change-3108052346d72a5b370a5dd64588efa8"><strong>[orm] [feature]</strong> </span><p>Added a new load option <a class="reference internal" href="../orm/loading_columns.html#sqlalchemy.orm.load_only" title="sqlalchemy.orm.load_only"><code class="xref py py-func docutils literal notranslate"><span class="pre">orm.load_only()</span></code></a>.  This allows a series
...
<li><p id="change-0.9.0b1-11"><span class="target" id="change-8ee7cac9783d870a07c279041dd11bc9"><strong>[orm] [feature]</strong> </span><p>The <code class="docutils literal notranslate"><span class="pre">eager_defaults</span></code> flag of <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper.Mapper" title="sqlalchemy.orm.mapper.Mapper"><code class="xref py py-class docutils literal notranslate"><span class="pre">Mapper</span></code></a> will now allow the
...
provided via the <a class="reference internal" href="../core/event.html#sqlalchemy.event.remove" title="sqlalchemy.event.remove"><code class="xref py py-func docutils literal notranslate"><span class="pre">event.remove()</span></code></a> function.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
the object is now an event-specific object called <a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">attributes.Event</span></code></a>.
...
to the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.aliased" title="sqlalchemy.orm.aliased"><code class="xref py py-func docutils literal notranslate"><span class="pre">orm.aliased()</span></code></a>, <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Join.alias" title="sqlalchemy.sql.expression.Join.alias"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Join.alias()</span></code></a>, and
<a class="reference internal" href="../orm/inheritance_loading.html#sqlalchemy.orm.with_polymorphic" title="sqlalchemy.orm.with_polymorphic"><code class="xref py py-func docutils literal notranslate"><span class="pre">orm.with_polymorphic()</span></code></a> functions, which allows an “alias” of a
...
<a class="changelog-reference headerlink reference internal" href="#change-e7e01f7d15796a940fa6608c2a24096c">¶</a><p>This change is also <strong>backported</strong> to: 0.8.3, 0.7.11</p>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="migration_09.html#migration-2736"><span class="std std-ref">Query.select_from() no longer applies the clause to corresponding entities</span></a></p>
</div>
...
<a class="changelog-reference headerlink reference internal" href="#change-eb0b93a1244b5f1389a13544c801b4cf">¶</a><p>This change is also <strong>backported</strong> to: 0.8.3, 0.7.11</p>
...
<code class="docutils literal notranslate"><span class="pre">None</span></code> <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.null" title="sqlalchemy.sql.expression.null"><code class="xref py py-func docutils literal notranslate"><span class="pre">expression.null()</span></code></a> <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.true" title="sqlalchemy.sql.expression.true"><code class="xref py py-func docutils literal notranslate"><span class="pre">expression.true()</span></code></a>
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.false" title="sqlalchemy.sql.expression.false"><code class="xref py py-func docutils literal notranslate"><span class="pre">expression.false()</span></code></a>, including consistency in rendering NULL
...
<a class="changelog-reference headerlink reference internal" href="#change-97b9ec01528f6ce1a103f8b8800d8b35">¶</a><p>This change is also <strong>backported</strong> to: 0.8.3, 0.7.11</p>
...
WITH keyword.</p>
<a class="changelog-reference headerlink reference internal" href="#change-0b6b7933cd03daaa51c88661f6a18a77">¶</a><p>This change is also <strong>backported</strong> to: 0.8.3, 0.7.11</p>
...
<a class="changelog-reference headerlink reference internal" href="#change-ee864489da68afbc90051f4bb9d0f94c">¶</a><p>This change is also <strong>backported</strong> to: 0.8.3, 0.7.11</p>
...
<li><p id="change-0.9.0b1-81"><span class="target" id="change-8d6f26937d8905e155c0deb811a65b8c"><strong>[mysql] [feature]</strong> </span><p>The MySQL <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.SET" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-class docutils literal notranslate"><span class="pre">mysql.SET</span></code></a> type now features the same auto-quoting
behavior as that of <a class="reference internal" href="../dialects/mysql.html#sqlalchemy.dialects.mysql.ENUM" title="sqlalchemy.dialects.mysql.ENUM"><code class="xref py py-class docutils literal notranslate"><span class="pre">mysql.ENUM</span></code></a>.  Quotes are not required when
...
Hanno Schlichting.</p>
<a class="changelog-reference headerlink reference internal" href="#change-8770e442e32764b20ee2132358bc9d6d">¶</a><p>This change is also <strong>backported</strong> to: 0.8.3, 0.7.11</p>
