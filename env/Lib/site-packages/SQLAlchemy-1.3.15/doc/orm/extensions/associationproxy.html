...
<code class="docutils literal notranslate"><span class="pre">UserKeyword.string_key</span></code> value to <code class="docutils literal notranslate"><span class="pre">Keyword</span></code> objects:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">user</span> <span class="o">=</span> <span class="n">User</span><span class="p">(</span><span class="s1">&#39;log&#39;</span><span class="p">)</span>
...
as the target attribute.  For example, the <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.any" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.any"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.any()</span></code></a>
and <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.has" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.has"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.has()</span></code></a> operations are available, and will produce
...
using the <code class="xref py py-attr docutils literal notranslate"><span class="pre">attr</span></code> attribute in a star-args context:</p>
...
<p><code class="xref py py-attr docutils literal notranslate"><span class="pre">attr</span></code> is composed of <code class="xref py py-attr docutils literal notranslate"><span class="pre">AssociationProxy.local_attr</span></code> and <code class="xref py py-attr docutils literal notranslate"><span class="pre">AssociationProxy.remote_attr</span></code>,
...
<code class="sig-prename descclassname">sqlalchemy.ext.associationproxy.</code><code class="sig-name descname">association_proxy</code><span class="sig-paren">(</span><em class="sig-param">target_collection</em>, <em class="sig-param">attr</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.association_proxy" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.ext.associationproxy.</code><code class="sig-name descname">AssociationProxy</code><span class="sig-paren">(</span><em class="sig-param">target_collection</em>, <em class="sig-param">attr</em>, <em class="sig-param">creator=None</em>, <em class="sig-param">getset_factory=None</em>, <em class="sig-param">proxy_factory=None</em>, <em class="sig-param">proxy_bulk_set=None</em>, <em class="sig-param">info=None</em>, <em class="sig-param">cascade_scalar_deletes=False</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__eq__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.__eq__" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">target_collection</em>, <em class="sig-param">attr</em>, <em class="sig-param">creator=None</em>, <em class="sig-param">getset_factory=None</em>, <em class="sig-param">proxy_factory=None</em>, <em class="sig-param">proxy_bulk_set=None</em>, <em class="sig-param">info=None</em>, <em class="sig-param">cascade_scalar_deletes=False</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.__init__" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__le__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.__le__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">__lt__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.__lt__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">__ne__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.__ne__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">extension_type</code><em class="property"> = symbol('ASSOCIATION_PROXY')</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.extension_type" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.for_class">
<code class="sig-name descname">for_class</code><span class="sig-paren">(</span><em class="sig-param">class_</em>, <em class="sig-param">obj=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.for_class" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="../mapping_api.html#sqlalchemy.orm.mapper.Mapper.all_orm_descriptors" title="sqlalchemy.orm.mapper.Mapper.all_orm_descriptors"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Mapper.all_orm_descriptors</span></code></a>, and we want to view the
...
<code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">is_aliased_class</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_aliased_class" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.is_attribute">
<code class="sig-name descname">is_attribute</code><em class="property"> = True</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_attribute" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.is_clause_element">
<code class="sig-name descname">is_clause_element</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_clause_element" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.is_instance">
<code class="sig-name descname">is_instance</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_instance" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.is_mapper">
<code class="sig-name descname">is_mapper</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_mapper" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.is_property">
<code class="sig-name descname">is_property</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_property" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxy.is_selectable">
<code class="sig-name descname">is_selectable</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxy.is_selectable" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.ext.associationproxy.</code><code class="sig-name descname">AssociationProxyInstance</code><span class="sig-paren">(</span><em class="sig-param">parent</em>, <em class="sig-param">owning_class</em>, <em class="sig-param">target_class</em>, <em class="sig-param">value_attr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="Permalink to this definition">¶</a></dt>
...
<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.__eq__">
<code class="sig-name descname">__eq__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.__eq__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="xref py py-meth docutils literal notranslate"><span class="pre">__eq__()</span></code> <em>method of</em> <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
</div>
<p>Return self==value.</p>
...
<code class="sig-name descname">__le__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.__le__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="xref py py-meth docutils literal notranslate"><span class="pre">__le__()</span></code> <em>method of</em> <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
</div>
<p>Return self&lt;=value.</p>
...
<code class="sig-name descname">__lt__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.__lt__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="xref py py-meth docutils literal notranslate"><span class="pre">__lt__()</span></code> <em>method of</em> <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
</div>
<p>Return self&lt;value.</p>
...
<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.__ne__">
<code class="sig-name descname">__ne__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.__ne__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="xref py py-meth docutils literal notranslate"><span class="pre">__ne__()</span></code> <em>method of</em> <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
</div>
<p>Return self!=value.</p>
...
<code class="sig-name descname">any</code><span class="sig-paren">(</span><em class="sig-param">criterion=None</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.any" title="Permalink to this definition">¶</a></dt>
<dd><p>Produce a proxied ‘any’ expression using EXISTS.</p>
<p>This expression will be a composed product
using the <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.any" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.any"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.any()</span></code></a>
and/or <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.has" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.has"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.has()</span></code></a>
operators of the underlying proxied attributes.</p>
</dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.attr">
<code class="sig-name descname">attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.attr" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">delete</code><span class="sig-paren">(</span><em class="sig-param">obj</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.delete" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.for_proxy">
<em class="property">classmethod </em><code class="sig-name descname">for_proxy</code><span class="sig-paren">(</span><em class="sig-param">parent</em>, <em class="sig-param">owning_class</em>, <em class="sig-param">parent_instance</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.for_proxy" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.get">
<code class="sig-name descname">get</code><span class="sig-paren">(</span><em class="sig-param">obj</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.get" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.has">
<code class="sig-name descname">has</code><span class="sig-paren">(</span><em class="sig-param">criterion=None</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.has" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.info" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.local_attr">
<code class="sig-name descname">local_attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.local_attr" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">remote_attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.remote_attr" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">scalar</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.scalar" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">set</code><span class="sig-paren">(</span><em class="sig-param">obj</em>, <em class="sig-param">values</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.set" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="attribute">
<dt id="sqlalchemy.ext.associationproxy.AssociationProxyInstance.target_class">
<code class="sig-name descname">target_class</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.target_class" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.ext.associationproxy.</code><code class="sig-name descname">ObjectAssociationProxyInstance</code><span class="sig-paren">(</span><em class="sig-param">parent</em>, <em class="sig-param">owning_class</em>, <em class="sig-param">target_class</em>, <em class="sig-param">value_attr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance" title="Permalink to this definition">¶</a></dt>
...
<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.__le__">
<code class="sig-name descname">__le__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.__le__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="xref py py-meth docutils literal notranslate"><span class="pre">__le__()</span></code> <em>method of</em> <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
</div>
<p>Return self&lt;=value.</p>
...
<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.__lt__">
<code class="sig-name descname">__lt__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.__lt__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="xref py py-meth docutils literal notranslate"><span class="pre">__lt__()</span></code> <em>method of</em> <code class="xref py py-class docutils literal notranslate"><span class="pre">object</span></code></p>
</div>
<p>Return self&lt;value.</p>
...
<code class="sig-name descname">any</code><span class="sig-paren">(</span><em class="sig-param">criterion=None</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.any" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.any" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.any"><code class="xref py py-meth docutils literal notranslate"><span class="pre">any()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
...
<code class="sig-name descname">attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.attr" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.attr" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.attr"><code class="xref py py-attr docutils literal notranslate"><span class="pre">attr</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
...
<code class="sig-name descname">contains</code><span class="sig-paren">(</span><em class="sig-param">obj</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.contains" title="Permalink to this definition">¶</a></dt>
<dd><p>Produce a proxied ‘contains’ expression using EXISTS.</p>
<p>This expression will be a composed product
using the <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.any" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.any"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.any()</span></code></a>
, <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.has" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.has"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.has()</span></code></a>,
and/or <a class="reference internal" href="../internals.html#sqlalchemy.orm.properties.RelationshipProperty.Comparator.contains" title="sqlalchemy.orm.properties.RelationshipProperty.Comparator.contains"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RelationshipProperty.Comparator.contains()</span></code></a>
operators of the underlying proxied attributes.</p>
</dd></dl>

<dl class="method">
<dt id="sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.has">
<code class="sig-name descname">has</code><span class="sig-paren">(</span><em class="sig-param">criterion=None</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.has" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.has" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.has"><code class="xref py py-meth docutils literal notranslate"><span class="pre">has()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
...
<code class="sig-name descname">local_attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.local_attr" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.local_attr" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.local_attr"><code class="xref py py-attr docutils literal notranslate"><span class="pre">local_attr</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
...
<code class="sig-name descname">remote_attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.remote_attr" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.remote_attr" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.remote_attr"><code class="xref py py-attr docutils literal notranslate"><span class="pre">remote_attr</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
...
<code class="sig-name descname">scalar</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance.scalar" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.scalar" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.scalar"><code class="xref py py-attr docutils literal notranslate"><span class="pre">scalar</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.ext.associationproxy.</code><code class="sig-name descname">ColumnAssociationProxyInstance</code><span class="sig-paren">(</span><em class="sig-param">parent</em>, <em class="sig-param">owning_class</em>, <em class="sig-param">target_class</em>, <em class="sig-param">value_attr</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">__le__</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.__le__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">__lt__</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.__lt__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">__ne__</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.__ne__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">all_</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.all_" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">any</code><span class="sig-paren">(</span><em class="sig-param">criterion=None</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.any" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.any" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.any"><code class="xref py py-meth docutils literal notranslate"><span class="pre">any()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
<p>Produce a proxied ‘any’ expression using EXISTS.</p>
...
<code class="sig-name descname">any_</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.any_" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">asc</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.asc" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.attr" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.attr" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.attr"><code class="xref py py-attr docutils literal notranslate"><span class="pre">attr</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
<p>Return a tuple of <code class="docutils literal notranslate"><span class="pre">(local_attr,</span> <span class="pre">remote_attr)</span></code>.</p>
...
<code class="sig-name descname">between</code><span class="sig-paren">(</span><em class="sig-param">cleft</em>, <em class="sig-param">cright</em>, <em class="sig-param">symmetric=False</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.between" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">bool_op</code><span class="sig-paren">(</span><em class="sig-param">opstring</em>, <em class="sig-param">precedence=0</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.bool_op" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">collate</code><span class="sig-paren">(</span><em class="sig-param">collation</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.collate" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">concat</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.concat" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">contains</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.contains" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">desc</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.desc" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">distinct</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.distinct" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">endswith</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.endswith" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">has</code><span class="sig-paren">(</span><em class="sig-param">criterion=None</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.has" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.has" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.has"><code class="xref py py-meth docutils literal notranslate"><span class="pre">has()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
<p>Produce a proxied ‘has’ expression using EXISTS.</p>
...
<code class="sig-name descname">ilike</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">escape=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.ilike" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">in_</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.in_" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">is_</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.is_" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">is_distinct_from</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.is_distinct_from" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">isnot</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.isnot" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">isnot_distinct_from</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.isnot_distinct_from" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">like</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">escape=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.like" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">local_attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.local_attr" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.local_attr" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.local_attr"><code class="xref py py-attr docutils literal notranslate"><span class="pre">local_attr</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
<p>The ‘local’ class attribute referenced by this
...
<code class="sig-name descname">match</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.match" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">notilike</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">escape=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.notilike" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">notin_</code><span class="sig-paren">(</span><em class="sig-param">other</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.notin_" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">notlike</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">escape=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.notlike" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">nullsfirst</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.nullsfirst" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">nullslast</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.nullslast" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">op</code><span class="sig-paren">(</span><em class="sig-param">opstring</em>, <em class="sig-param">precedence=0</em>, <em class="sig-param">is_comparison=False</em>, <em class="sig-param">return_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.op" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">operate</code><span class="sig-paren">(</span><em class="sig-param">op</em>, <em class="sig-param">*other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.operate" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">remote_attr</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.remote_attr" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.remote_attr" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.remote_attr"><code class="xref py py-attr docutils literal notranslate"><span class="pre">remote_attr</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
<p>The ‘remote’ class attribute referenced by this
...
<code class="sig-name descname">reverse_operate</code><span class="sig-paren">(</span><em class="sig-param">op</em>, <em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.reverse_operate" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<code class="sig-name descname">scalar</code><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.scalar" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance.scalar" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance.scalar"><code class="xref py py-attr docutils literal notranslate"><span class="pre">scalar</span></code></a> <em>attribute of</em> <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a></p>
</div>
<p>Return <code class="docutils literal notranslate"><span class="pre">True</span></code> if this <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a>
...
<code class="sig-name descname">startswith</code><span class="sig-paren">(</span><em class="sig-param">other</em>, <em class="sig-param">**kwargs</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance.startswith" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<dd><dl class="simple">
<dt>Symbol indicating an <code class="xref py py-class docutils literal notranslate"><span class="pre">InspectionAttr</span></code> that’s</dt><dd><p>of type <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxy" title="sqlalchemy.ext.associationproxy.AssociationProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxy</span></code></a>.</p>
</dd>
</dl>
